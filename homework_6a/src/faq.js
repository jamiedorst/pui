        ...
        <div id="faqSect">
          ...
          <div className="question">
            ...
            <p>
              ...
              are certain things you can do to make it as soft and luxurious for
              as long as possible. Make sure to handwash it in warm water, and
              hang it to dry. Never dry clean it or use bleach.
            </p>
          </div>
          <div className="question">
            <h6>
            ...
            <p>
              ...
              email to view any unexpected delays in shipping. If that does not
              help, please email us at fluff@stuff.com and we will look into the
              problem.
            </p>
          </div>
          <div className="question">
            ...
            <p>
              ...
              subject “Return Request” and include your order number in the body
              of the email. From there we will provide you with a return
          ...
          <div className="question">
            ...
            <p>
              ...
              loved a previous seasonal color, we’re sorry that it is no longer
              in production! Please send us a note at fluff@stuff.com to request
              that we make your favorite color a permanent part of our
              collection.
            </p>
          </div>
          <Link
